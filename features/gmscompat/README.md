...
- `external/AppCompatConfig`: GrapheneOS commit
  `6e90a551fdd9b92739076b3916c1cdee944faaa4`, providing the pinned
  `AppCompatConfig` module required by the framework services build.
